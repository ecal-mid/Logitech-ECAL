...
echo "Copying IMPORTANT_READ_ME.txt to distribution contents..."
...
cat > build/release/${APP_DIR_NAME}/remove_quarantine.command << EOF
#!/bin/bash
...
read -n 1
EOF
chmod +x build/release/${APP_DIR_NAME}/remove_quarantine.command
