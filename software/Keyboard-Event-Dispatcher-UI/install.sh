...
# Keyboard-OSC-Dispatcher Installer Script
...
APP_NAME="KeyboardOSCDispatcher.app"

echo -e "${BLUE}=== Keyboard OSC Dispatcher Installer ===${NC}"
...
echo "Keyboard OSC Dispatcher has been installed to your Applications folder."
