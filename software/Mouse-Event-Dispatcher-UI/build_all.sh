...
# Source files
SOURCE_FILES="MouseEventDispatcherApp.swift OSCSupport.swift"

# Application names
APP_NAME="Mouse-OSC-Dispatcher"
APP_DIR_NAME="MouseOSCDispatcher"
BUNDLE_ID="com.ecal.mouse-osc-dispatcher"

# Compiler flags
SWIFT_FLAGS="-framework Foundation -framework AppKit -framework SwiftUI -framework CoreGraphics -parse-as-library"
...
swiftc $SWIFT_FLAGS -o build/$APP_NAME.app/Contents/MacOS/$APP_NAME $SOURCE_FILES
...
<dict>
    ...
    <string>This app needs to monitor input events to provide event logging and blocking functionality.</string>
    <key>NSAccessibilityUsageDescription</key>
    <string>This app needs accessibility permissions to monitor and block input events.</string>
...
<dict>
    ...
    <string>1.0</string>
    <key>CFBundleVersion</key>
    <string>1.0.$(date +%Y%m%d)</string>
    <key>LSMinimumSystemVersion</key>
    <string>10.15</string>
    <key>NSHumanReadableCopyright</key>
    <string>Copyright © 2025 ECAL All rights reserved. Build: $(date)</string>
    <key>NSPrincipalClass</key>
    <string>NSApplication</string>
    <key>NSSupportsAutomaticTermination</key>
    <true/>
